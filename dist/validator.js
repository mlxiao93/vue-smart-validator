(function (global, factory) {
    ...
    var DirectiveParamParser = /** @class */ (function () {
        ...
        DirectiveParamParser.prototype.setVModelKey = function (data) {
            ...
            if (data.model) {
                ...
                vModel = data.directives.filter(function (item) {
    ...
    function number(value, _a) {
        var max = _a.max, min = _a.min, integer = _a.integer, float = _a.float, positive = _a.positive,
    ...
    var Validator = /** @class */ (function () {
        function Validator(_a) {
            var rules = _a.rules, options = _a.options, vModelKey = _a.vModelKey, context = _a.context,
                errorEl = _a.errorEl, targetEl = _a.targetEl, vnode = _a.vnode;
            this.validators = [];
        ...
        Validator.prototype.getExistsTriggers = function () {
            var triggerObj = {};
            this.validators.map(function (item) {
                return triggerObj[item.trigger] = true;
            });
            return Object.keys(triggerObj);
        };
        Validator.prototype.check = function (_a) {
            var trigger = _a.trigger;
            var _b = this, validators = _b.validators, context = _b.context, errorEl = _b.errorEl,
                vModelKey = _b.vModelKey, vnode = _b.vnode;
            var model = vnode.data.directives.filter(function (item) {
                return item.name === 'model';
            })[0] || vnode.data.model;
        ...
        Validator.prototype.firstError = function () {
            ...
            if (isEmpty(error))
                return;
            var key = Object.keys(error).filter(function (item) {
                ...
                if (onlyOneEditableFormElChild(targetEl)) {
                    triggers.map(function (trigger) {
                        targetEl.querySelector('input, select, textarea').addEventListener(trigger, function () {
                            setTimeout(function () {
                                return validator.check({trigger: trigger});
                            });
                        });
                    });
                }
    ...
    var validatorDirective = {
        ...
        update: function (el, bindings, vnode, oldVnode) {
            ...
            var oldModal = oldVnode.data.directives.filter(function (item) {
                return item.name === 'model';
            })[0] || oldVnode.data.model;
            var newModal = vnode.data.directives.filter(function (item) {
                return item.name === 'model';
            })[0] || vnode.data.model;
            var paramParser = new DirectiveParamParser({modifiers: modifiers, value: value, data: data, el: el});
            // 更新validator对象
